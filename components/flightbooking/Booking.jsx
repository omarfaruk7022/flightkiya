            ...
            <div className=" flex flex-col gap-8">
                    ...
                    <div className=" flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {" "}
                          {new Date(segment.DepartureDateTime).toDateString()}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">
                    ...
                    <div>
                      ...
                      <div className="text-sm mt-4 space-y-4">
                        <p className=" text-[16px]">
                          <strong className="text-[18px]">Cancellation:</strong>{" "}
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 mb-4">
                ...
                <div className="flex justify-between text-sm mb-2">
                  <p>
                    {segment.PassengerTypeQuantity?.Quantity || 2} Passenger
                  </p>
                  <p>
                    {segment.PassengerTypeQuantity?.Code === "ADT"
                      ? "Adult"
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="text-gray-700 mt-2 space-y-1">
                    ...
                    <div className="flex justify-between">
                      <span>Tax</span>
                      <span className="font-medium">
                        {flightdata.Taxes.Amount}{" "}
                        {flightdata.Taxes.CurrencyCode}
                      </span>
                    </div>
                    <hr className="my-2" />
                    <div className="flex justify-between">
